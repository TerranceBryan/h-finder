  ...
  <div class="header">
                ...
                <div class="header-left">
                    <a href="dashboard.php" class="logo">
						<img src="assets/img/profile-logo.png" alt="Logo">
					</a>
                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-building"></i> <span>State & City</span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
							...
							<li class="submenu">
								<a href="#"><i class="fe fe-question"></i> <span> Query </span> <span class="menu-arrow"></span></a>
								<ul style="display: none;">
