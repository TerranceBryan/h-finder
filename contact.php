	...
	if(!empty($name) && !empty($email) && !empty($phone) && !empty($subject) && !empty($message))
	{
		...
		$sql="INSERT INTO contact (name,email,phone,subject,message) VALUES ('$name','$email','$phone','$subject','$message')";
		   ...
		   if($result){
			   ...
			   $error = "<p class='alert alert-warning'>Message Not Sent</p> ";
		   }
	}else{
...
<div id="page-wrapper">
    <div class="row"> 
                            ...
                            <ul>
                                <li class="d-flex mb-4"> <i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        ...
                                        <span class="text-secondary">kenyatta avenue, Nakuru Town East, Nakuru</span> 
										<span class="text-secondary">Uasin Gishu, Rift Valley</span>
										</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Call Us</h5>
                                        <span class="d-table text-secondary">712 345 678</span>
										<span class="text-secondary">012 345 809 </span>
									</div>
                                </li>
                                <li class="d-flex mb-4"> <i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>
                                    <div class="contact-address">
                                        <h5 class="text-white">Email Address</h5>
										<span class="d-table text-secondary">support@urbanhomefinder</span>
										<span class="text-secondary">support@urbanhomefinder</span>
										</div>
                                </li>
                            </ul>
                        </div>
        ...
        <!--	Map -->
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3989.771216568312!2d36.056014575023994!3d-0.2784128997188335!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x18298da5768e0781%3A0xfdaa3a2d97607cde!2sKabarak%20University%20Nakuru%20Town%20Campus!5e0!3m2!1sen!2ske!4v1709892832847!5m2!1sen!2ske" width="100%" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		<!--	Map -->
