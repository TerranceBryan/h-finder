<footer class="full-row bg-secondary p-0">
            <div class="container">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 col-lg-4">
                                            <div class="footer-widget">
                                                ...
                                                <ul class="text-white">
                                                    <li class="hover-text-primary"><i class="fas fa-map-marker-alt text-white mr-2 font-13 mt-1"></i>Kenyatta avenue, Nakuru 20100,Kenya</li>
                                                    <li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+254 123-4567</li>
													<li class="hover-text-primary"> <i class="fas fa-phone-alt text-white mr-2 font-13 mt-1"></i>+254 123-4567</li>
                                                    <li class="hover-text-primary"><i class="fas fa-envelope text-white mr-2 font-13 mt-1"></i>office@Ufinder.com</li>
                                                </ul>
                                            </div>
                ...
                <div class="row copyright">
                    <div class="col-sm-6"> <span class="text-white">&copy2024 Urban finder All right reserved</span> </div>
                    <div class="col-sm-6">
